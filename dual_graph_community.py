...
class Dual_Graph_Community:
    ...
    def run_method(self):
        ...
        LG = self.dual_graph_community_analysis.read_graph(layer)
        LG = self.dual_graph_community_analysis.Community_Analysis(LG)
        LG = self.dual_graph_community_analysis.Centrality_Analysis(LG)
        output = self.dual_graph_community_analysis.create_layer(LG)
        self.dual_graph_community_analysis.visualise_layer(output)
        self.dlg.close()
